...
*Этот проект демонстрирует реальную уязвимость схемы защиты TPM+PIN в systemd-cryptenroll - программную эмуляцию атаки faulTPM без какого-либо физического вмешательства в аппаратный TPM.*
